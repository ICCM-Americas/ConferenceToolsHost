...
return [
    ...
    */
    ...
    // Management routes already run inside the authenticated route group, so we
    // do not require a separate password-confirmation step here. Passkey
    // enrollment/removal works smoothly for already-authenticated users.
    ...
    */
    ...
    // Passkey verification redirect target. "/dashboard" applies the same
    // phase-aware redirect used after password login.
    'redirect' => '/dashboard',
